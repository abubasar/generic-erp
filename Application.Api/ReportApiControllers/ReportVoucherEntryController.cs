...
namespace ErpReport.Controllers
{
    ...
    [ApiController]
    public class ReportVoucherEntryController : ControllerBase
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IWorkContext _workContext;
        private readonly ITenantService _tenantService;

        public ReportVoucherEntryController(IUnitOfWork unitOfWork, IWorkContext workContext, ITenantService tenantService)
        {
        ...
        public async Task<IActionResult> JournalEntries(Guid voucherEntryId)
        {
            // ==============================
            ...
            headerPage.AddCell(new PdfPCell(new Phrase(voucherEntry?.VoucherType == 1 ? "Cash Payment Voucher" : "Cash Received Voucher", fontArial14Bold)) { Border = 0, PaddingTop = 3f, HorizontalAlignment = Element.ALIGN_CENTER });
            ...
            {
                int? voucherType = voucherEntry.VoucherType;
                String? voucherNo = voucherEntry.VoucherNo;
                String cashBankAccountName = _unitOfWork.Repository<Account>().TableNoTracking().FirstOrDefault(x => x.Id == voucherEntry.CashBankAccountId)?.Name ?? "";
                String code = _unitOfWork.Repository<Account>().TableNoTracking().FirstOrDefault(x => x.Id == voucherEntry.CashBankAccountId)?.Code ?? "";
                ...
                tableVoucherEntry.AddCell(new PdfPCell(new Phrase("Date:", fontArial9)) { Border = 0, PaddingTop = 3f, PaddingLeft = 5f, PaddingRight = 5f, HorizontalAlignment = 2 });
                tableVoucherEntry.AddCell(new PdfPCell(new Phrase(voucherDate, fontArial9)) { Border = 0, PaddingTop = 3f, PaddingLeft = 5f, PaddingRight = 5f, HorizontalAlignment = 2 });
                ...
                tableVoucherEntry.AddCell(new PdfPCell(new Phrase("Ref. No: ", fontArial9)) { Border = 0, PaddingTop = 3f, PaddingLeft = 5f, PaddingRight = 5f, HorizontalAlignment = 2 });
                tableVoucherEntry.AddCell(new PdfPCell(new Phrase(referenceNo, fontArial9)) { Border = 0, PaddingTop = 3f, PaddingLeft = 5f, PaddingRight = 5f, HorizontalAlignment = 2 });
                ...
                {
                    int sl = 1;
                    PdfPTable tableVoucherEntryItems = new(5);
                    ...
                    tableVoucherEntryItems.AddCell(new PdfPCell(new Phrase("Account Name / Description", fontArial9)) { HorizontalAlignment = 1, PaddingTop = 3f, PaddingBottom = 3f });
                    ...
                    tableVoucherEntryItems.AddCell(new PdfPCell(new Phrase("DR", fontArial9)) { HorizontalAlignment = 1, PaddingTop = 3f, PaddingBottom = 3f });
                    tableVoucherEntryItems.AddCell(new PdfPCell(new Phrase("CR", fontArial9)) { HorizontalAlignment = 1, PaddingTop = 3f, PaddingBottom = 3f });
                    ...
                    tableVoucherEntryItems.AddCell(new PdfPCell(new Phrase(voucherType == 2 ? totalAmount.ToString("#,##0.00") : "0.00", fontArial9)) { HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = 3f, PaddingLeft = 5f, PaddingRight = 5f });
                    tableVoucherEntryItems.AddCell(new PdfPCell(new Phrase(voucherType == 1 ? totalAmount.ToString("#,##0.00") : "0.00", fontArial9)) { HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = 3f, PaddingLeft = 5f, PaddingRight = 5f });

                    if (voucherType == 1)
                    {
                        foreach (var voucherEntryItem in voucherEntryItems)
                        {
                            sl++;
                            tableVoucherEntryItems.AddCell(new PdfPCell(new Phrase(sl.ToString(), fontArial9)) { HorizontalAlignment = 1, PaddingTop = 3f, PaddingBottom = 3f, PaddingLeft = 5f, PaddingRight = 5f });
                            tableVoucherEntryItems.AddCell(new PdfPCell(new Phrase(voucherEntryItem.AccountName, fontArial9)) { HorizontalAlignment = 0, PaddingTop = 3f, PaddingBottom = 3f, PaddingLeft = 5f, PaddingRight = 5f });
                            tableVoucherEntryItems.AddCell(new PdfPCell(new Phrase(voucherEntryItem.Code, fontArial9)) { HorizontalAlignment = 1, PaddingTop = 3f, PaddingBottom = 3f, PaddingLeft = 5f, PaddingRight = 5f });
                            tableVoucherEntryItems.AddCell(new PdfPCell(new Phrase(voucherEntryItem.Amount.ToString("#,##0.00"), fontArial9)) { HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = 3f, PaddingLeft = 5f, PaddingRight = 5f });
                            tableVoucherEntryItems.AddCell(new PdfPCell(new Phrase("0.00", fontArial9)) { HorizontalAlignment = 2, PaddingTop = 3f, PaddingBottom = 3f, PaddingLeft = 5f, PaddingRight = 5f });
                        }
                    }
                    if (voucherType == 2)
                    {
