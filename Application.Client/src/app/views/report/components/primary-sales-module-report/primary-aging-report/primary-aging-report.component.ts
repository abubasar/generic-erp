      ...
      .post(
        environment.apiURL +
          ...
          $event?.submitter?.name == "excel"
            ? "/SaleInvoice/primary-sale-aging-report-print"
            : "/SaleInvoice/primary-temporary-sale-aging-report-print"),
      ...
      .subscribe((response) => {
        if (
          ...
          if ($event?.submitter?.name == "excel") {
            ...
            link.setAttribute("download", "Temporary_Aging_Report.xlsx");
